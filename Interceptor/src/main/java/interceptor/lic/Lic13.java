...
/**
 * LIC 13: There exists at least one set of three data points, separated by exactly A_PTS and B_PTS
 * consecutive intervening points, respectively, that cannot be contained within or on a circle of
 * radius RADIUS1.
 * In addition, there exists at least one set of three data points (which can be the same or different
 * from the three data points just mentioned) separated by exactly A_PTS and B_PTS consecutive
...
public final class Lic13 {
    ...
    public static boolean evaluate() {
        ...
        double radius2 = Globals.PARAMETERS.RADIUS2;
